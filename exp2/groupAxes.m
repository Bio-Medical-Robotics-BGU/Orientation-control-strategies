function [KnoBLmean,KnoBL,KnoBLmean_FML,KnoBL_FML] = groupAxes(D,initials,group,keeptrials)
...
KnoBL_FML = KnoBL(1:60,:,:);
for trNum=1:60
    KnoBLmean_FML(trNum,:) = meanDirection3D(squeeze(KnoBL_FML(trNum,:,:))')';
end
