...
[bootstat,~] = bootstrp(1E4,@skewness,QGS(:));
ci = quantile(bootstat,[(1-0.95)/2,(1+0.95)/2]);
skewness(QGS(:))

ranova_QGS = exp1_statistics();


%% Create figures
% Fig. 5 - Representative examples of a geodesic and a non-geodesic
exp1_example()
% Fig. 6 - Median QGS and 95% CI
exp1_results()
% Fig. 7 - The time course of the QGS values
exp1_learning()
